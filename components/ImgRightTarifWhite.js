...
const ImgRightTarifWhite = ({ icon, introPageImg, text, titre }) => {
	return (
		<section className="relative  md:h-[400px] lg:h-[340px] flex flex-col flex-wrap  bg-white">
			<div className="h-[200px] md:w-[60%] right-0 md:absolute md:h-[400px] lg:h-[340px]">
				<Image
			...
			<div className="container relative ">
				<div className="py-10 md:w-[35%] md:absolute flex justify-center flex-col md:h-[400px] lg:h-[340px]">
