			...
			<main>
				...
				<section className=" ">
					<div className="w-full">
						<div className="h-[500px] lg:w-[60%]  lg:absolute">
							<iframe
						...
						<div className="md:container mx-auto relative py-10  lg:py-0  lg:h-[500px]">
							<div className="lg:absolute flex justify-end items-start flex-col px-5 pb-0 bg-white  lg:pb-10 lg:ml-[68%]  lg:h-[500px] 2xl:pr-16">
								<div className="">
								...
								<p className="text-sm leading-5  md:text-justify mt-3 xl:leading-6 xl:text-md">
									...
									tourner à droite sur le chemin du Poisson Blanc jusqu’au
									Domaine Aventurier Inc. (2km)
								</p>
							</div>
						</div>
					</div>
